...
function catalogue() {
	...
	$content="";
		...
		<a href=\"s5.php?addtocart=".$row['id']."\">Положить в корзину</a><br><br>";
	return $content;
}
?>
<!DOCTYPE html>
...
echo "<a href=\"s5.php?clear=1\">Очистить корзину</a> <br><br>","<a href=\"cart.php\">Перейти в корзину</a><br><br>";
?>
	</div>
	<div class="soder">
		<h1>Lenovo Vibe S1</h1>
		<hr width="500px" color=#00fadf>
		<br>
			<img class="imgknew" src="s5.jpg">
<?
echo catalogue();
?>
			<p class="PROCH">Коротко о товаре<br><br>
<ul style="text-align: left">
    <li>смартфон, Android 5.0
<li>поддержка двух SIM-карт
<li>экран 5", разрешение 1920x1080
...
<li>аккумулятор 2420 мА⋅ч
<li>вес 132 г, ШxВxТ 70.80x143.30x7.80 мм
    </ul>
