...
function catalogue() {
	...
	$content="";
		...
		<a href=\"k2.php?addtocart=".$row['id']."\">Положить в корзину</a><br><br>";
	return $content;
}
?>
<!DOCTYPE html>
...
echo "<a href=\"k2.php?clear=1\">Очистить корзину</a> <br><br>","<a href=\"cart.php\">Перейти в корзину</a><br><br>";
?>
	</div>
	<div class="soder">
		<h1>Philips Xenium E570</h1>
		<hr width="500px" color=#00fadf>
		<br>
			<img class="imgknew" src="k2.jpg">
<?
echo catalogue();
?>
...
<li>экран 2.8", разрешение 320x240
<li>камера
<li>память 128 Мб, слот для карты памяти
<li>Bluetooth
<li>объем оперативной памяти 64 Мб
<li>аккумулятор 3160 мА⋅ч
<li>вес 156 г, ШxВxТ 58.60x133.50x15.70 мм
<li>MP3-плеер, радио
    </ul>
