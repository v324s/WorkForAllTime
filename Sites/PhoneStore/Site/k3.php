...
function catalogue() {
	...
	$content="";
		...
		<a href=\"k3.php?addtocart=".$row['id']."\">Положить в корзину</a><br><br>";
	return $content;
}
?>
<!DOCTYPE html>
...
echo "<a href=\"k3.php?clear=1\">Очистить корзину</a> <br><br>","<a href=\"cart.php\">Перейти в корзину</a><br><br>";
?>
	</div>
	<div class="soder">
		<h1>KENEKSI X9</h1>
...
<ul style="text-align: left">
    <li>телефон
<li>оддержка двух SIM-карт
<li>экран 2.8", разрешение 320x240
<li>камера 1.30 МП
<li>слот для карты памяти
<li>Bluetooth
<li>аккумулятор 1000 мА⋅ч
<li>ШxВxТ 56x130x11 мм
<li>MP3-плеер, радио
    </ul>
