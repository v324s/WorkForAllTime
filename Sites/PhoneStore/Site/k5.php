...
function catalogue() {
	...
	$content="";
		...
		<a href=\"k5.php?addtocart=".$row['id']."\">Положить в корзину</a><br><br>";
	return $content;
}
?>
<!DOCTYPE html>
...
echo "<a href=\"k5.php?clear=1\">Очистить корзину</a> <br><br>","<a href=\"cart.php\">Перейти в корзину</a><br><br>";
?>
	</div>
	<div class="soder">
		<h1>Fly TS112</h1>
...
<ul style="text-align: left">
    <li>телефон
<li>поддержка трех SIM-карт
<li>экран 2.8", разрешение 320x240
<li>камера 1.30 МП
<li>память 32 Мб, слот для карты памяти
<li>Bluetooth
<li>объем оперативной памяти 32 Мб
<li>аккумулятор 1400 мА⋅ч
<li>вес 100 г, ШxВxТ 55.70x130.50x12.40 мм
<li>MP3-плеер, радио
    </ul>
