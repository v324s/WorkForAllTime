info_glav=false;
		...
		glbrend=($("#slide_1").innerHeight())+($("#slide_2").innerHeight())-($("#slide_2").innerHeight()/2);
		glbrona=($("#slide_1").innerHeight())+($("#slide_2").innerHeight())+($("#slide_3").innerHeight())-($("#slide_3").innerHeight()/2);
		glbronkont=($("#slide_1").innerHeight())+($("#slide_2").innerHeight())+($("#slide_3").innerHeight())+($("#slide_4").innerHeight())-($("#slide_4").innerHeight()/1.5);
		viewmap=false;
